...
winner = []
strat_choices = [[DumbStrategyLevel1, BerserkerStrategyLevel1], [BerserkerStrategyLevel1, DumbStrategyLevel1]]
...
print('\nBerserker Won', winner.count(0), 'percent of the time against Dumb Strategy!')