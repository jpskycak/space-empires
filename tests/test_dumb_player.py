...
correct_example.get_current_active_file('space-empires/test_logs', 'test_dumb_player')

test = correct_example.read_info()

with log.active_file as text, correct_example.active_file as exc: #print lines that are different from the correct example
